// HIEF Core Type Definitions
// Generated from HIEF-INT-01, HIEF-SOL-01, HIEF-POL-01, HIEF-REP-01 specs

// ─── Shared Primitives ────────────────────────────────────────────────────────

export type Address = string;   // 0x-prefixed 20-byte hex
export type Bytes32 = string;   // 0x-prefixed 32-byte hex
export type HexString = string; // 0x-prefixed arbitrary hex
export type UintString = string; // decimal integer as string
...
export interface ReputationScores {
  ...
  volumeScore: number;    // 0-1000
  diversityScore: number; // 0-1000
  alphaScore?: number;    // 0-1000
}
