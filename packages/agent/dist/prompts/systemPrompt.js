...
exports.AMENDMENT_SYSTEM_PROMPT = exports.CONFIRMATION_SYSTEM_PROMPT = exports.INTENT_EXTRACTION_SYSTEM_PROMPT = void 0;
exports.INTENT_EXTRACTION_SYSTEM_PROMPT = `You are the HIEF Intent Parser — a specialized AI component that translates natural language DeFi instructions into structured intent parameters.
...
exports.CONFIRMATION_SYSTEM_PROMPT = `You are the HIEF Intent Confirmer. Your job is to present a clear, human-readable summary of a DeFi transaction for user confirmation.
...
exports.AMENDMENT_SYSTEM_PROMPT = `You are the HIEF Intent Amender. The user wants to modify a previously parsed intent.
