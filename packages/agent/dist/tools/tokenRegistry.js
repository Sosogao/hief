...
exports.MAINNET_TOKENS = exports.BASE_TOKENS = void 0;
 ...
 */
function resolveToken(symbolOrAlias, chainId) {
    const normalized = symbolOrAlias.trim().toLowerCase();
    // Direct address match
    if (normalized.startsWith('0x') && normalized.length === 42) {
        return (ALL_TOKENS.find((t) => t.address.toLowerCase() === normalized && t.chainId === chainId) ?? {
    ...
    return (ALL_TOKENS.find((t) => t.chainId === chainId &&
        (t.symbol.toLowerCase() === normalized ||
            t.aliases.includes(normalized))) ?? null);
}
/**
